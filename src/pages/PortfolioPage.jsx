  ...
  return (
    <div>
      <div className="flex flex-row ml-6 gap-4">
        <div
          className="flex relative hover:pr-10 group items-center justify-center shadow-lg hover:bg-lightnavy text-bgblue transition-all duration-500 hover:scale-110 bg-navy rounded-3xl w-fit px-4 h-fit py-3 text-xl font-inter"
